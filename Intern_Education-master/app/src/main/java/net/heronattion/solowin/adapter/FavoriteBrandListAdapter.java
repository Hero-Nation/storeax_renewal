...
public class FavoriteBrandListAdapter extends BaseAdapter {
    ...
    public FavoriteBrandListAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = minflater.inflate(R.layout.favorite_brand_item, parent, false);
